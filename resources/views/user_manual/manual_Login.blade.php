...
<p>
    If you have successfully forgotten your password, please go to the <a>Restore</a> page, and enter the email address
    linked to your account and press "send password reset link".
</p>
<p>
...
<p>
    if the email is not registered in the system with your id, or if you lost access to the email you linked to your
    account.
    then you will have to contact the <a href="{{ route('contact.create') }}">database admin</a>, so your password or
    email will be changed manually.
</p>
